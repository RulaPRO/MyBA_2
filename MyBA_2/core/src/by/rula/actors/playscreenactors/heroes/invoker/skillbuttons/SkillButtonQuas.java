...
public class SkillButtonQuas extends SkillButton {

    private Invoker invoker;

    public SkillButtonQuas(final Invoker hero) {
        super(hero);
        invoker = hero;
        ...
        addListener(new InputListener() {
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                System.out.println("Im QUAS");
                invoker.addSphere(InvokerSphere.QUAS);
                return true;
            }
        });
    }
