 ...
 */
public class SkillButtonCullingBlade extends SkillButton {

    private Axe axe;

    public SkillButtonCullingBlade(Axe hero) {
        super(hero);
        axe = hero;
        ...
        addListener(new InputListener() {
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                System.out.println("Im Culling Blade");
                //axe.setAnimations(Axe.CULLING_BLADE);
                return true;
            }
        });
    }
